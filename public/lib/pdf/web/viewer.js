    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      const PDFViewerApplication = {
        ...
        async run(config) {
          ...
          key = params.get("file") ?? _app_options.AppOptions.get("defaultUrl");
          file =
            "file" in params
              ? params.file
          ...
          if (window.require) {
            ...
            if (fs.existsSync(filePath)) {
              pdfFileUrl = url.pathToFileURL(path.resolve(filePath)).href;
            } else if (fs.existsSync(libPath)) {
              pdfFileUrl = url.pathToFileURL(path.resolve(libPath)).href;
            }
            ...
            let result = await (localforage || window.localforage).getItem(key);
            const arrayBuffer = result;
            const mimeType = "application/pdf";
            pdfFileUrl = arrayBufferToUrl(arrayBuffer, mimeType);
          }
          file = pdfFileUrl;
