...
export function handleRenderBookWithLinesColors(renderBookWithLineColors:()=>void){
  return {type:"HANDLE_RENDER_BOOK_WITH_LINES_COLORS", payload:renderBookWithLineColors}
}
