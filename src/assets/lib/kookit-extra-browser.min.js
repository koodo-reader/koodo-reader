...
class SyncHelper {
    ...
    static startSync(compareResult, ConfigService, DatabaseService, ConfigUtil, BookUtil, CoverUtil) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.syncConfig(compareResult, ConfigService, DatabaseService, BookUtil, ConfigUtil);
            yield this.syncCover(CoverUtil);
            yield this.syncBook(ConfigService, BookUtil);
        });
    }
    ...
    static syncBook(ConfigService, BookUtil) {
        return __awaiter(this, void 0, void 0, function* () {
            let localBookList = yield BookUtil.getLocalBookList();
            let cloudBookList = yield BookUtil.getCloudBookList();
