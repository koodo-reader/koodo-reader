...
const voice14 = require("./voice/gptsovitsVoice");
...
const voicePlugins = {
    ...
    "gptsovits-voice-plugin": voice14,
    "coquitts-voice-plugin": voice15,
};
const getVoicePlugin = (key) => Object.prototype.hasOwnProperty.call(voicePlugins, key)
    ? voicePlugins[key]
    : undefined;
const isVoicePluginKey = (key) => Object.prototype.hasOwnProperty.call(voicePlugins, key);
